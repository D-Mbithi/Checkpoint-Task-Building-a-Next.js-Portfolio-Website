    ...
    <div className="flex flex-col items-center justify-center w-full bg-slate-900 p-20 min-h-screen">
        <div className="container mx-auto space-y-5">
            <div className="flex flex-col w-full">
                <h1 className="text-3xl text-slate-200 font-bold mb-4">About Me</h1>
                <p className="text-sm text-slate-100">I am a software engineer passionate about creating elegant code and exceptional web experiences. With a background in web technologies and software design, I love solving complex engineering problems and translating user needs into clean, interactive applications. Outside of programming, I stay up to date on browser standards, experiment with emerging web frameworks, and contribute to open-source code. I enjoy building things that scale, are fast, and feel responsive to the touch.</p>
            </div>
            <div className="flex flex-col w-full mx-auto">
                <h2 className="text-2xl text-slate-300">Technical Skills</h2>
                <div className="flex gap-x-4 w-full justify-center items-center">
                    <div className="space-y-2">
                        <h3 className="text-slate-200 text-xl font-semibold">Frontend</h3>
                    ...
                    <div>
                        <h3 className="text-slate-300 text-xl font-semibold">Backend & DBs</h3>
                        <ul className="space-y-1">
                    ...
                    <div>
                        <h3 className="text-slate-300 text-xl font-semibold">DevOps & Tools</h3>
                        <ul className="space-y-1">
                ...
                <div className="space-y-8 border-l border-slate-800 pl-6 ml-4">
                    <div className="relative group">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-zinc-400 leading-relaxed mt-2">Intensive training in data structures, algorithms, databases, full-stack JavaScript frameworks, and DevOps practices.</p>
                        </div>
                    </div>
                </div>
            </div>
